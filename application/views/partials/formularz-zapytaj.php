...
<?php echo form_open(); ?>
<input type="hidden" name="contact_product_id" value="<?= $product_data->id; ?>">
<?php if (!empty($error_message)): ?>
    <div class="alert alert-<?= $success ? 'success' : 'danger'; ?>"><?php echo $error_message; ?></div>
<?php endif ?>
<div class="row">
    ...
    <div class="col-sm-12 padding_rest_size">
        <div class="form-group wow fadeInUp" data-wow-delay="0.4s" style="font-size: 12px">
            <input type="checkbox" name="term1" value="1" required="1" style="opacity: 1;" />
            <?= strip_tags((new CustomElementModel('19'))->getField('fiszka1')->value, '<a><span><strong><b><i><u>'); ?>  
        </div>
<!--        <div class="form-group wow fadeInUp" data-wow-delay="0.5s">
            <input type="checkbox" name="term2" value="1" required="1" style="opacity: 1;" />
        ...
        <div class="privacy_policy wow fadeInUp" data-wow-delay="0.6s">
            ...
            <a href="<?= site_url('/polityka-prywatnosci'); ?>" style="float:left;" ><?= (new CustomElementModel('19'))->getField('polityka_prywatności'); ?></a>
        </div>
    </div>
    ...
    <div class="col-sm-6 col-md-6 padding_rest_size btn_send_padding">
        <div class="form-group wow fadeInUp" data-wow-delay="0.8s">
            <button type="submit" class="button_send btn-primary btn-block" name="send" value="1"><?= (new CustomElementModel('11'))->getField('przeslij formularz'); ?></button>
        </div>
    </div>  
<?php echo form_close(); ?>