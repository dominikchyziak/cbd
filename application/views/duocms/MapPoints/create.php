<h2 class="pull-left">Dodaj punkt zainteresowania</h2><a href="<?= site_url('duocms/points');?>" class="btn btn-primary pull-right">< Powrót</a>
...
<?php /*<p>Obrazek</p>
<div class="col-sm-12">
    <input type="text" name="icon_marker" class="form-control" onclick="openKCFinderImage(this, 'images')" readonly="true">
</div> */ ?>
...
<div class="col-sm-12">
    <select name="gallery_id" class="form-control">
        ...
        <option value="<?= $cat->id; ?>"><?= $cat->getTranslation(LANG)->name; ?></option>
        <?php      endforeach; ?>
    </select>
</div>
<div class="col-sm-12">
