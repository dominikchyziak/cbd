                ...
                <div class="col-12 col-md-6 col-lg-6 col-xl-5 p-1-xl">                            
                    ...
                    <div class="sekcja-newsletter-form">
                        <form method="POST" id="newsletter_form">
                            <input type="text" name="mail" id="newsletter_email" placeholder="<?= (new CustomElementModel('2'))->getField('newsletter placeholder'); ?>">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-12">
                        <div class="sekcja-aktualnosci-zaw-przycisk">
                            <a href="<?=site_url('blog'); ?>" class="przycisk"><?= (new CustomElementModel('9'))->getField('pokaz wszystkie'); ?></a>
                        </div> 
                    </div>
                </div>                                                                           
            </div>
