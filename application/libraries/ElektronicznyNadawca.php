...
class pobranieType {
  ...
  public $nrb; // anonymous55
  public $tytulem; // anonymous56
  public $sprawdzenieZawartosciPrzesylkiPrzezOdbiorce; // boolean
}
...
class przesylkaPaletowaType {
  ...
  public $daneSent; // daneSentType
  public $awizacja; // awizacjaType
  public $zawartosc; // string
  public $masa; // masaType
  ...
  public $dostawaWSobote; // boolean
  public $przygotowanieDokumentowPrzewozowych; // boolean
  public $dostawaSamochodemDedykowanym; // boolean
  public $zmianaDanychAdresowych; // boolean
  public $ustalenieTerminuDostawy; // boolean
  public $samochodZWinda; // boolean
  public $zabranieOpakowania; // boolean
  public $wniesienie; // boolean
  public $awizoSMS; // boolean
}
...
class oczekujeNaZgodeEZwrotType {
  public $sklepEZwrot; // shopEZwrotyType
  public $idZgody; // int
...
class statusZgodyEZwrotType {
  ...
  public $guidZgodaEZwrot; // guidType
  public $status; // statusZgodyEZwrotNameType
  public $platnoscZaPrzesylke; // boolean
  public $kosztKontrahenta; // int
  public $dataWygasnieciaZgody; // date
}
...
class jednostkaOrganizacyjnaType {
  ...
  public $id; // int
  public $nazwa; // anonymous312
  public $opis; // anonymous313
  public $mpk; // string
}
...
class daneSentType {
  public $numer; // string
  public $kluczPrzewoznika; // string
  public $kodCN; // string
  public $kodPKWiU; // string
  public $masa; // decimal
  public $proceduraAwaryjna; // boolean
}
